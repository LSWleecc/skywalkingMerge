...
export const MIXHANDLE_CHANGE_GROUP = 'MIXHANDLE_CHANGE_GROUP';
export const SET_ROOT_DATA = 'SET_ROOT_DATA';
export const SET_ALARM_STRATEGY_LIST = 'SET_ALARM_STRATEGY_LIST';
export const SET_METRICS_ALARM_RULE = 'SET_METRICS_ALARM_RULE';
export const CREATE_METRIC_ALARM_RULE = 'CREATE_METRIC_ALARM_RULE';
export const SET_EVENT_ALARM_STRATEGY_LIST = 'SET_EVENT_ALARM_STRATEGY_LIST';
...
//callerAnalysis
export const SET_CALLER_ANALYSIS_SERVICE = 'SET_CALLER_ANALYSIS_SERVICE';
export const SET_CALLER_ENDPOINT = 'SET_CALLER_ENDPOINT';
export const SET_CALLER_LIST = 'SET_CALLER_LIST';
export const SET_CALLER_TOTAL = 'SET_CALLER_TOTAL';
export const SET_CURRENTCALLER_SERVICE = 'SET_CURRENTCALLER_SERVICE';
export const SET_CURRENTCALLER_ENDPOINT = 'SET_CURRENTCALLER_ENDPOINT';

//dependencyAnalysis
export const SET_DEPENDENCY_SERVICE = 'SET_DEPENDENCY_SERVICE';
export const SET_ENDPOINT = 'SET_ENDPOINT';
export const SET_CURRENTINVOK_SERVICE = 'SET_CURRENTINVOK_SERVICE'
export const SET_CURRENTINVOK_ENDPOINT = 'SET_CURRENTINVOK_ENDPOINT'
